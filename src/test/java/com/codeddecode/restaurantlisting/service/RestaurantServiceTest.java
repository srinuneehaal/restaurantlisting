...
import com.sb.restaurantlisting.service.RestaurantService;
...
public class RestaurantServiceTest {
	...
	public void testFindAllRestaurants() {
		...
		for (int i = 0; i < mockRestaurants.size(); i++) {
			RestaurantDTO expectedDTO = RestaurantMapper.iNSTANCEMapper
	...
	public void testAddRestaurantInDB() {
		...
		Restaurant mockRestaurant = RestaurantMapper.iNSTANCEMapper.mapRestaurantDTOTORestaurant(mockRestaurantDTO);
